...
//             }}
//           />
//           <div className="relative border-2 flex w-full ">      
//           <Input
//             title={`Password`}
//             id={`password`}
//             // type={`password`}
...
//             }}
//           />
//           <FaEyeSlash className="absolute right-1 top-3 cursor-pointer w-[10%]" onClick={()=>setIsHarshed(!isHarshed)} />
...
//       <ForgotPassword heading="Login" showForgotPassword={true} />
//     </div>
