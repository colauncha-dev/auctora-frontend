...
//   // -------------------------------
//   // Fetch blogs for list section
//   // -------------------------------
//   const fetchBlogs = async () => {
//     try {
//       setLoading(true);
//       const res = await fetch(`${current}blogs`);
...
//   useEffect(() => {
//     if (activeTab.label === 'List') fetchBlogs();
//   }, [activeTab]);
...
//     try {
//       const resp = fetch(`${current}blogs`, {
//         credentials: 'include',
//         method: 'POST',
//         body: formData,
//       });
...
//                       {blog.author?.first_name} • {blog.estimated_reading_time}s
//                     </p>
