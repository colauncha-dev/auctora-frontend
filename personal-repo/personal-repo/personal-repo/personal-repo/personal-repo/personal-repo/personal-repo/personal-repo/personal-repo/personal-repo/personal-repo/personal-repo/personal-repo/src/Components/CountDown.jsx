...
const CountDown = () => {
  ...
  return (
    <div className="mt-8 lg:py-[80px] flex flex-col gap-5 md:gap-8 lg:gap-[32px]">
      {/* Heading */}
      <h1 className="w-full text-[26px] sm:text-[32px] md:text-[44px] lg:text-[60px] leading-tight font-[700] text-[#9F3247]">
        Your Gateway to Exciting Auctions
      </h1>

      {/* Description */}
      <p className="w-full text-sm sm:text-[15px] md:text-[17px] text-[#9F3247] leading-relaxed">
        Discover treasures at Biddius - where bidding meets buying. Join online
        auctions and find unique items to buy and sell with excitement!
      </p>

      {/* Stopwatch and Button */}
      <div className="flex flex-col-reverse gap-6 md:flex-col items-center md:items-start">
        <Stopwatch days={5} hours={4} minutes={55} seconds={35} />
        <div className="w-full">
          <Button
            label="Bid Now"
            className="bg-gradient-to-r from-[#7B2334] to-[#9F3247] w-full sm:w-[180px] lg:w-[200px]"
