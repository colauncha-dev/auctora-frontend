...
const AuthNote = ({ heading, body, button }) => {
  return (
    <div className="w-[620px] h-[560px]  bg-gradient-to-r from-[#7B2334] to-[#9F3247] rounded-tr-md rounded-br-md flex place-content-center place-items-center flex-col p-10 gap-4">
